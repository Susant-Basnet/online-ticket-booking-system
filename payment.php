				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="panel panel-success">
							<div class="panel-heading">
								<h3 class="panel-title">3. VISITOR'S INFO
								</h3>
							</div>
							<div class="panel-body">
								VISITOR'S DETAILS
	...
	<div class="col-md-6">
		<div class="panel panel-default">
			<div class="panel-body">
			 ...
			 <div class="panel panel-success">
			 	<div class="panel-heading">
			 		<h3 class="panel-title"><center>DATE</center></h3>
			 	</div>
			 	<div class="panel-body">
			 		<strong>
			 			<i>Pokhara Stadium Online Ticket Booking</i>
			 			<h3>
			 			...
			 			<p>Date: <?= $_SESSION['departure_date']; ?> @9:00AM</p>
			 		</strong>
			 			<i>Arrive before one hour of the match.</i><br />
			 			<strong>
